...
//            pending=รอตรวจสอบ
    ...
    public Response getBalanceListLite(
        ...
        try {
            ...
            // flag=0: query เบาๆ จาก ic_inventory ตรงๆ ไม่มี price subquery — แต่ส่ง balance_qty + year_weak กลับ
            ...
            if (flag != 0) {
                ...
                __strQuery = new StringBuilder();                __strQuery.append("select ");
            ...
            ResultSet __rsData = __stmtData.executeQuery(__strQuery.toString() + __strPaginationQuery);            JSONArray __jsonArr = new JSONArray();
            while (__rsData.next()) {
                JSONObject obj = new JSONObject();
...
// ============================================================
    ...
    // getBalanceDetailPrice — lazy load ราคาสำหรับ detail row (expansion)
    // รับ item_code, location, unit_code, cust_code, sale_type
    // ถ้า location เป็นตัวเลข 4 หลัก → ic_inventory_price_formula
    // fallback → getProductPriceLocal
    // ============================================================
    @GET
    ...
    public Response getBalanceDetailPrice(
        ...
        try {
            ...
            String custCode = (strCustCode != null && !strCustCode.trim().isEmpty()) ? strCustCode.trim() : "";
            String saleType = (strSaleType != null && !strSaleType.trim().isEmpty()) ? strSaleType.trim() : "1";
